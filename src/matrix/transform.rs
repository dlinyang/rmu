...
pub fn rotation2(theta: f32) -> Mat2f {
    [[theta.cos(), -theta.sin()]
    ,[theta.sin(),  theta.cos()]]
}
...
pub fn rotation3(x: f32, y: f32, z:f32) -> Mat3f {
...
pub fn translation1(x: f32) -> Mat2f {
    [[1f32,   x ]
    ,[0f32, 1f32]]
}

pub fn translation2(x: f32, y: f32) -> Mat3f {
    [[1f32, 0f32,  x  ]
    ,[0f32, 1f32,  y  ]
    ,[0f32, 0f32, 1f32]]
}

pub fn translation3(x: f32, y: f32, z: f32) -> Mat4f {
    [[1f32, 0f32, 0f32,   x ]
    ,[0f32, 1f32, 0f32,   y ]
    ,[0f32, 0f32, 1f32,   z ]
    ,[0f32, 0f32, 0f32, 1f32]]
